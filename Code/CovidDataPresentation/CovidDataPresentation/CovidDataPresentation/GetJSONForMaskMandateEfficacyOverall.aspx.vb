...
Public Class GetJSONForMaskMandateEfficacyOverall
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Dim dt As DataTable = GetOverallMaskEfficacyData()
    ...
    Private Function GetOverallMaskEfficacyData() As DataTable
        ...
        Doc_cmd.CommandText = "prc_CaseNumbersWithAndWithoutMandate_PerCapita"
